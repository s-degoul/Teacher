...
<div class='content_target'>
	...
	<div class='how_to_guide'>
		<p><?php echo _("<strong>Le médecin</strong> présente à l’enfant un débitmètre de pointe et lui explique son utilité : mesurer le souffle."); ?></p>
		<p><?php echo _("possibilité de montrer"); ?>
			<a href = '.?module=patient_teaching&action=show_video_peakflow&from=target_6'  class = 'link_video'>
				<img src = 'images/picto_video.jpg' alt = '<?php echo _("voir la vidéo"); ?>' width=20 />
				<?php echo _("la vidéo d’Achille : «je mesure mon souffle»"); ?>
			</a>
		</p>
		<p><?php echo _("Il lui fait faire 3 mesures selon les consignes du tableau (cliquer sur le tableau)"); ?></p>
		<p>
		...
		<p>
			<?php echo _("Pour savoir si la valeur obtenue est réellement la valeur du patient, il faut la comparer aux valeurs théoriques des abaques définies en fonction de la taille de l’enfant</a>");?>
			<?php echo CheckPDFExists('t6_normal_peakflow_values')?'(<a href=\''.CheckPDFExists('t6_normal_peakflow_values').'\'>'._("télécharger les abaques").'</a>)':''; ?>
		</p>
		<p><?php echo _("<strong>Le médecin</strong> explique qu’en cas de crise d’asthme, les bronches se resserrent et l’air a du mal à passer :
		...
		<p><?php echo _("<strong>Le médecin :</strong> explique qu’il y a aussi une <span class = 'text_red'><strong>valeur alerte grave</strong></span>
		...
		<p><?php echo _("<strong>L’enfant</strong> la note sur sa feuille"); ?></p>
		<p><?php echo _("<strong>Le médecin</strong> explique à l’enfant à quels moments mesurer son souffle avec le DEP :"); ?></p>
		<ul>
			...
			<li><?php echo _("au moins deux fois par an chez le médecin car avec la croissance et l’âge, les valeurs du DEP se modifient."); ?></li>
		</ul>
...
<?php
TargetInfoBox(array(
				'learning_method' => array (_("apprentissage du geste technique")),
				'duration' => '10 min',
				'print' => array (
								't6_peakflow_measure' => array (
											'title' => _("Je sais mesurer mon souffle"),
											'before_title' => _("la fiche"),
											'after_title' => ''
											)
								),
				'material' => array (
									_("un débitmètre de pointe, idéalement celui de l’enfant"),
									array (
										'link' => '.?module=patient_teaching&action=show_video_peakflow&from=target_6',
										'title' => _("Video d’Achille sur la mesure du DEP"),
										'before_title' => '',
										'after_title' => ''
										)
									)
